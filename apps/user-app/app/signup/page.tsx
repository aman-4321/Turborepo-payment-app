  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 pb-20">
      <div className="bg-white p-12 rounded-xl shadow-lg w-[30rem] text-center">
        ...
        <div className="text-2xl font-medium mb-6">Signup</div>
        ...
        <button className="w-full px-6 py-3 border border-blue-500 text-blue-500 rounded-lg font-bold transition-transform hover:scale-105">
          Sign Up
        </button>
      </div>
    </div>
